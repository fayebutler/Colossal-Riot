...
{
  BaseEntity* sender = EntityMgr->getEntityFromID(_senderID);
  BaseEntity* receiver = EntityMgr->getEntityFromID(_receiverID);
...
void MessageManager::send(BaseEntity* _receiver, const Message &_message)
{
