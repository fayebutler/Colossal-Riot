...
//----------------------------------------------------------------------------------------------------------------------------
MovingEntity::MovingEntity(GameWorld *world, ngl::Vec3 pos, float r, ngl::Vec3 velocity, float max_speed, ngl::Vec3 heading, float mass, float turn_rate, float max_force):BaseGameEntity(world, typeMovingEntity,pos,r),
                            m_velocity(velocity),
